...
train_split=0.8
batch_size=8
target_batch_size=128  #80 #128 #1024 
seed=123
load_weights=True
peft_type="lora"
...
warmup_steps=0.03
initial_lr=1e-5
min_lr=1e-5 #--> being calculated as 0.1 * of max LR (not used)
learning_rate=0.0008 #1e-4 #0.0008 #3e-4 --> Good LR (Karpathy) (max lr)
weight_decay=0.01
beta1=0.9
beta2=0.95
lora_rank=16
